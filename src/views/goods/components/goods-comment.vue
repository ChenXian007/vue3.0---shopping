<template>
  ...
  <!-- 列表 -->
    ...
    <xtx-pagination v-if="total" @current-change = changePager :total="total" :currengPage="reqParams.page" :pageSize='reqParams.pageSize' />
  </div>
</template>
<script>
...
export default {
  ...
  setup (props, { emit }) {
    ...
    return { commentInfo, currTagIndex, changeTag, reqParams, changeSort, formatSpecs, formatNickname, commentList, changePager, total }
  }
}
</script>
