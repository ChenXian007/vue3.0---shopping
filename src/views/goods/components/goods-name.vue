<template>
  ...
  <p class="g-name">{{goods.inventory}}</p>
  ...
  <div class="g-service">
    ...
    <dl>
      <dt>配送</dt>
      <dd>至 <XtxCity @change="changePos" :fullLocation= 'fullLocation' /> </dd>
    </dl>
    <dl>
      <dt>服务</dt>
      <dd>
...
export default {
  ...
  setup (props, { emit }) {
    ...
    const changePos = (pos) => {
      provinceCode.value = pos.provinceCode
      cityCode.value = pos.cityCode
      countyCode.value = pos.countyCode
      fullLocation.value = pos.fullLocation
    }
    return { fullLocation, changePos }
  }
