<template>
  ...
  <div class="sub-filter" v-if="filterData && !filterLoading">
    <div class="item">
      ...
      <div class="body">
        <a @click="changeBrand(brand.id)" :class="{active:filterData.brands.selectedBrand===brand.id}" href="javasript:;" v-for="brand in filterData.brands" :key="brand.id">{{brand.name}}</a>
      </div>
    </div>
